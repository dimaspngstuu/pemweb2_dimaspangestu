<!DOCTYPE html>
  <html lang="en">
    ...
    <body>
      <section id="homepage" class="bg-warning">
        <h1 class="text-center text-light">Alat Penghitung BMI</h1>
        <div class="container">
          <div class="card">
            <div class="card-body">
              <div class="row">
                  ...
                  <form method="POST" action="hasil.php">
                    ...
                    <div class="form-group">
                      ...
                      <div>
                        ...
                        <span id="tinggi-badanHelpBlock" class="form-text text-muted">hitungan KG </span>
                      </div>
                    </div>
                    <!-- end select area 1 -->
                    ...
                    <div class="form-group">
                      ...
                      <div>
                        ...
                        <span id="tinggi-badanHelpBlock" class="form-text text-muted">hitungan CM</span>
                      </div>
                    </div>
                    <!-- end select area 2 -->
                ...
                <div class="col-6 image">
                  <img src="assests/img/bmi.jpg" alt="bmi" />
                </div>
              </div>
            </div>
          </div>
